...
{
    public function testConvertAmountSameCurrency()
    {
//        $currencyAPI = new \Chatbot\Service\Factory\CurrencyAPIFactory();
        $configFiles = include __DIR__ . '/../../../../config/autoload/local.php';
        $currencyAPI = new CurrencyAPI($configFiles["currencyAPI"]);
        $conversion = $currencyAPI->convertAmount('BRL', 'BRL', '10');
        
        $this->assertEquals('10', $conversion);
    }
